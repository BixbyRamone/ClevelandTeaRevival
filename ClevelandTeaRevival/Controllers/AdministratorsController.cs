...
namespace ClevelandTeaRevival.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstName")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstName")] Administrator administrator)
        {
